  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff', gap: 30, paddingTop: 30  }}>
      ...
      <View style={{ gap: 15, paddingHorizontal: 20,}}>
        ...
        <ItemProfile iconLeft={<Image source={require('../../../assets/images/profile/ic_logout.png')} style={styles.ic_profile} />} title='Đăng xuất' iconRight={<IconChevronRight />} onPress={() => { logout() }} />
      </View>
